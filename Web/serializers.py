...
class UserCreateSerializer(ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        new_user.profile.birthdate = profile["birthdate"]
        new_user.save()
...
class DiseasesSymptomsSerializer(serializers.ModelSerializer):
    class Meta:
        model = DiseasesSymptoms
        fields = ('id', 'symptoms')
...
class HumanSystemsSerializer(serializers.ModelSerializer):
